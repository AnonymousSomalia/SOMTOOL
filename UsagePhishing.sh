...
version="v 1.0.0"
echo " _   _ ____   ____ _____   ____  _   _ ___ ____  _   _ ___ _   _  ____" | lolcat
echo "| | | / ___| / ___| ____| |  _ \| | | |_ _/ ___|| | | |_ _| \ | |/ ___|" | lolcat
echo "| | | \___ \| |  _|  _|   | |_) | |_| || |\___ \| |_| || ||  \| | |  _" | lolcat
echo "| |_| |___) | |_| | |___  |  __/|  _  || | ___) |  _  || || |\  | |_| |" | lolcat
echo " \___/|____/ \____|_____| |_|   |_| |_|___|____/|_| |_|___|_| \_|\____|" | lolcat
cat <<- AUI
${RED}                                            ${version}
AUI
echo "  |----------------------------------------------------|" | lolcat
